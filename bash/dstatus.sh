...
dList="ntp smbd nmbd transmission-daemon chtorrent plexmediaserver nginx php5-fpm memcached mysql fail2ban saslauthd postfix dovecot ttrssd sagemath syncthing discosrv smartmontools clamav-freshclam clamav-daemon"
